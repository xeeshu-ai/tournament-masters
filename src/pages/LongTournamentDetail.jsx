        ...
        <div className="card overflow-x-auto text-xs">
          {loading ? (
            ...
            <table className="table">
              <thead>
                <tr>
                  <th>#</th><th>Team</th><th>Host</th><th>UID</th><th>Teammates</th><th>Status</th><th>Order ID</th><th>Payment ID</th><th>Registered</th><th>Actions</th>
                </tr>
              </thead>
              <tbody>
                    ...
                    <tr key={r.id}>
                      ...
                      <td>
                        <div className="flex gap-1.5">
                          {r.status !== 'confirmed' && (
                            <button type="button" disabled={isBusy} onClick={() => handleRegStatus(r, 'confirmed')}
                          ...
                          {r.status !== 'rejected' && (
                            <button type="button" disabled={isBusy} onClick={() => handleRegStatus(r, 'rejected')}
                          ...
                          {r.status !== 'pending' && (
                            <button type="button" disabled={isBusy} onClick={() => handleRegStatus(r, 'pending')}
